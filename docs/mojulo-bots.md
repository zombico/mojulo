...
A wizard builder and observability dashboard for Mojulo Bots. It runs locally or on your own private cloud, single-operator, with an opt-in login as a last-line-of-defense affordance — it is the operator's tool, not a tenant-facing service.
