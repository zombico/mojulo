    ...
    inputSchema: {
      ...
      properties: {
        primitive: {
          type: 'string',
          description:
            "Primitive ref (e.g. 'document-store', 'issue-tracker'). Must match a primitive declared in the mcp-orbit-components/primitive/ directory.",
        },
        role: {
          type: 'string',
