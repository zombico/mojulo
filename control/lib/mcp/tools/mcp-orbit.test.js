...
// Short-circuit the semantic-index sidecar — this suite covers composer
// behavior, not embedding indexing. Without the flag every recommend
// handler call would await the ONNX model.
