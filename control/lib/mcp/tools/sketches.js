    ...
    inputSchema: {
      ...
      properties: {
        ...
        cdn: {
          type: 'boolean',
          default: false,
          description: "html only. Default true: three.js off the pinned jsdelivr CDN, because an artifact host's CSP refuses inline `data:` scripts at ANY size. `false` writes the self-contained `world.offline.html` (~1 MB larger, opens from file:// with no network).",
        },
        scale: {
          type: 'number',
          description:
