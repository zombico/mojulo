  ...
  registerTool({
    ...
    inputSchema: {
      ...
      properties: {
        ...
        format: {
          type: 'string',
          enum: ['glb', 'stl', '3mf', 'usda', 'usdz', 'scad', 'html'],
          default: 'glb',
          description:
