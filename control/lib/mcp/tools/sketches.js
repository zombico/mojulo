    ...
    inputSchema: {
      ...
      properties: {
        ...
        cdn: {
          type: 'boolean',
          default: false,
          description: 'html only: load three.js from the pinned jsdelivr CDN instead of inline (~1 MB smaller; needs network, so not file://) — for a page door with a byte limit.',
        },
        scale: {
          type: 'number',
          description:
