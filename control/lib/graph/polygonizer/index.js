...
- polygonizer.constellation: optional CCA (Cardinal Construction Axes) constellation grid. Each element's CCA is its local coordinate authority: a cardinal-named frame (E-W length, Zenith-Nadir height, depth toward the vanishing point) that solves the element's block before any visible skin is accepted. If omitted, Mojulo derives it deterministically from elements + draftingTable.
