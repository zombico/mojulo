...
import { roomFurnitureAssetFaces } from './room-assets.js';
...
function waveCaveFaces(surf, base, shade, { id, amp, relief = 0.8, rolls = 1.7, cell = 0.6, overlap = 1.09, seed = 1, lobeWavelength = 6.5, heightField } = {}) {
 ...
 */
export function buildRoundRoomShellFaces({ center = [0, 0], radius = 12, height = 11, segments, wallSurface, floorSurface = 'flat', ceilingSurface = 'flat', relief = 'rolling', reliefSeed = 1, domeRise, floorOptions = {}, ceilingOptions = {}, omit = [], caveOptions = {}, lighting, light, lamps = [], tint = [1, 1, 1], gravityDarken = true, palette = SURFACE_PALETTE } = {}) {
