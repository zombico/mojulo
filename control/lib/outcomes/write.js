 ...
 */
export async function writeOutcome({ cookRef, aim, slices, reportMd, visuals = [], suggestedLens }) {
...
// Test seam.
export const _internals = { escapeHtml, headline, validateVisual, fillTemplate, FILENAME_SAFE };
