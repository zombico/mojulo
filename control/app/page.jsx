...
function McpSkillsIcon({ className = 'h-10 w-10' }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
const TILES = [
  ...
  { key: 'mcpSkills', href: '/mcp-skills', Icon: McpSkillsIcon },
  ...
  return (
    <main className="min-h-[calc(100vh-33px)] p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-x-6 gap-y-8 mt-16">
          {TILES.map((tile) => (
            <Link
              key={tile.href}
              href={tile.href}
