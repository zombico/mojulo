...
/**
 * /mcp-skills/[ref]'s client body, inside the workshop shell (pinned posture).
 * page.jsx resolves the auth flag server-side and forwards the params promise.
 */
...
export default function ConnectedServiceDetailBody({ params, authEnabled = false }) {
