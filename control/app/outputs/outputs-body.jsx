...
/**
 * /outputs' client body — inbox of materialized publications ("output artifacts").
 *
 ...
 *
 * Wears the workshop shell pinned (AuthNav and the breadcrumb bar stand down
 * here): the header and filters stay put while the inbox rows scroll in their
 * own pane. page.jsx resolves the auth flag server-side and hands it down.
 */
...
export default function CooksIndexBody({ authEnabled = false }) {
  ...
  return (
    ...
    <div className="flex min-h-0 flex-1 flex-col">
      <div className="w-full shrink-0 px-8 pt-6 pb-0 max-w-5xl mx-auto">
      ...
      {/* The inbox rows scroll inside the pinned shell; header + filters stay put. */}
