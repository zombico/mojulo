...
/**
 * /observability's client body — MCP tool telemetry inside the workshop shell.
 * page.jsx resolves the auth flag server-side and hands it down for the
 * strip's sign-out. Scroll posture: the page was never a pinned instrument —
 * the tables read top to bottom and the document scrolls.
 */
...
export default function ObservabilityBody({ authEnabled = false }) {
  ...
  return (
    <WorkshopShell posture="scroll" width={1400} crumb={t('title')} authEnabled={authEnabled}>
      <div className="max-w-6xl mx-auto w-full px-6 py-8 text-[color:var(--text-primary)]">
