...
/**
 * /render-bay's client body — one place to watch mojulo produce something.
 *
 ...
 * strip's sign-out. The `?lane=` read needs useSearchParams, hence the
...
export default function RenderBayBody({ authEnabled = false }) {
  const t = useTranslations('renderBay');
  return (
    <WorkshopShell posture="scroll" width={1400} authEnabled={authEnabled} crumb={t('title')}>
