...
/**
 * /apps' client body. Mounted inside the workshop shell (pinned posture) by
 * page.jsx, which resolves the auth flag server-side for the strip.
 */
...
export default function AppsListBody({ authEnabled = false }) {
