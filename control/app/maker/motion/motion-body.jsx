...
/**
 * /maker/motion's client body — gallery of motion artifacts ("Motion Projects").
 *
 ...
 * here): the header and search stay put while the wall of cards scrolls in its
...
export default function MotionGalleryBody({ authEnabled = false }) {
  ...
  return (
    <WorkshopShell posture="pinned" width={1400} authEnabled={authEnabled} crumb={t('title')}>
      <div className="flex min-h-0 flex-1 flex-col">
        <div className="w-full shrink-0 px-8 pt-6 pb-4">
