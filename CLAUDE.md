...
- Version: `package.json` says 2.0.8 (released 2026-09-22; 2.0.5 is broken on fresh installs, see the changelog; the embedding runtime is the opt-in `recall` group since 2.0.7; the chatbot pack is opt-in since 2.0.0).
