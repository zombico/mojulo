...
- Optional local workers (Blender, ComfyUI, Kokoro, Godot) are operator-hosted and never dependencies. The substrate holds no binaries, keys, or worker state; absence degrades a loop, never breaks one.
